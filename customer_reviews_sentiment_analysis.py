...
def fetch_data_from_sql():
    ...
    conn_str = (
        ...
        "Server=VRAJ_10_ROG\SQLEXPRESS;"  # Specify your SQL Server instance
        "Database=VRAJ_MarketingAnalytics;"  # Specify the database name
...
# Fetch the customer reviews data into the dataframe from the SQL database
